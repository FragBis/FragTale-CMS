...
/**
 * Use static function "getInstanceOf", instead of using "new DB_Object()".
...
class Adapter{
	...
	public function __construct($connectionName=DEFAULT_DATABASE_CONNECTOR_NAME){
		...
		if (!file_exists($inifile)){
			APP::catchError('Database configuration error! "'.$inifile.'" file not found', __CLASS__, __FUNCTION__, __LINE__);
	...
	/**
	 * Return an existing or a created instance of DB_Object. Use this method instead of "new DB_Object()";
